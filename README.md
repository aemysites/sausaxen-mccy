...
## Environments
- Preview: https://main--sausaxen-mccy--aemysites.aem.page/
- Live: https://main--sausaxen-mccy--aemysites.aem.live/
...
1. Open the `sausaxen-mccy` directory in your favorite IDE and start coding :)
